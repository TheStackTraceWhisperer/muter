...
/**
 * Integration tests for the JUL implementation of the muter extension.
 */
class MuteExtensionJulTest {
    ...
    void directMuteWithEmptyClassesMutesRootAndRestoresLevel() {
        ROOT.setLevel(Level.INFO);
        MuteRestorer restorer = new JulMuter().mute(muteAnnotation());
    ...
    void directMuteWithClassesMutesOnlySelectedLoggersAndRestores() {
        ...
        SERVICE_A.setLevel(Level.FINE);
        SERVICE_B.setLevel(Level.SEVERE);
        MuteRestorer restorer = new JulMuter().mute(muteAnnotation(ServiceA.class, ServiceB.class));
