...
/**
 * Integration tests for the Log4j 2 implementation of the Kotest muter listener.
 */
class MuteKotestLog4j2Test {
    ...
    // ---------- MuteKotestListener + Log4j2Muter integration ----------

    @Test
    @DisplayName("MuteKotestListener with Log4j2Muter mutes root and restores for @Mute spec")
    void listenerMutesRootLoggerAndRestores() {
        Configurator.setRootLevel(Level.INFO);
        MuteKotestListener listener = new MuteKotestListener(List.of(new Log4j2Muter()));
    ...
    @Test
    @DisplayName("MuteKotestListener with Log4j2Muter mutes specific class logger")
    ...
    void nonLog4j2ContextFailsFast() {
        ...
        assertTrue(ex.getMessage().contains("muter-kotest-log4j"));
    }
