 ...
 * classpath (e.g., muter-logback, muter-log4j, muter-jul, or
 * muter-commons-logging); otherwise an {@link IllegalStateException} is thrown
        ...
        findMuteAnnotation(context).ifPresent(annotation -> {
            if (logMuters.isEmpty()) {
                throw new IllegalStateException(
                        ...
                        + "Add muter-logback, muter-log4j, muter-jul, or muter-commons-logging "
