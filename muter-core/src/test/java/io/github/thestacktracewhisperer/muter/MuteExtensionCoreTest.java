...
class MuteExtensionCoreTest {
    ...
    void contextWithoutMuteAnnotationIsIgnored() throws Exception {
        ...
        LogMuter mockMuter = annotation -> { muteCalled.set(true); return () -> {}; };
    ...
    void allLogMustersCalledAndRestored() throws Exception {
        ...
        LogMuter muter1 = annotation -> { muteCount.incrementAndGet(); return restoreCount::incrementAndGet; };
        LogMuter muter2 = annotation -> { muteCount.incrementAndGet(); return restoreCount::incrementAndGet; };
